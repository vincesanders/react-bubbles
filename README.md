...
- [ ] Explain what a token is used for.
      -They are used to tell the server what data the user is authorized to access.
- [ ] What steps can you take in your web apps to keep your data secure?
      -You can require a login and use protected routes.
- [ ] Describe how web servers work.
      -Web servers are internet-connected computers. They recieve our api requests and if we have the required authentications, they fulfill or attempt to fulfill our request and return a response or error.
